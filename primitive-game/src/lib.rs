...
#[no_mangle]
pub extern fn update_player(world: Handle, player_id: u32, input: Handle) -> Handle { DUMMY_HANDLE }

#[no_mangle]
pub extern fn add_player(world: Handle, player_id: u32) -> Handle { DUMMY_HANDLE }

#[no_mangle]
pub extern fn remove_player(world: Handle, player_id: u32) -> Handle { DUMMY_HANDLE }
